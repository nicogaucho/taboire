...
export const article = {
  date: '2024-02-18',
  title: 'Personalización y Sostenibilidad',
  description:
    'Nuestros clientes valoran nuestra capacidad para mejorar su reputación corporativa, reducir costos operativos y proporcionar acceso a conocimientos especializados en sostenibilidad, facilitando así su camino hacia un futuro más sostenible y rentable.',
  author: {
    name: 'Persona X',
    role: 'Co-Founder / CEO',
