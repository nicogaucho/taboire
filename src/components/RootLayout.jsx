...
import { HeadAbout, HeadImage } from '@/components/HeadImage'
          ...
          >
            <Icon
              className={clsx(
                'h-6 w-6',
                invert
                  ? 'fill-white group-hover:fill-white-200'
                  : 'fill-white group-hover:fill-white-700',
              )}
            />
          </button>
        </div>
...
// Grid per la navbar espansa per la navigazione
...
// Navbar espansa per la navigazione
function Navigation() {
  return (
    <nav className="mt-px font-display text-5xl font-medium tracking-tight text-white">
      <NavigationRow>
        <NavigationItem href="/">Proyectos</NavigationItem>
...
// Layout generale
// che comprende la navbar con la sua animazione per espandere
// Slot centrare main
// Footer
